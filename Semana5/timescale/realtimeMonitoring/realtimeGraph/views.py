...
def get_avg_data(request, **kwargs):
    ...
    if start == None and end == None:
        start = datetime.now()
        start = start - dateutil.relativedelta.relativedelta(months=14)
        end = datetime.now()
